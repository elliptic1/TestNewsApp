...
import androidx.compose.ui.unit.dp
import com.tbse.mininews.ui.article.postContentItems
import com.tbse.mininews.ui.article.sharePost
import com.tbse.mininews.ui.components.MiniNewsSnackbarHost
import com.tbse.mininews.ui.modifiers.interceptKey
import com.tbse.mininews.ui.rememberContentPaddingForScreen
import com.tbse.mininews.ui.theme.MiniNewsTheme
import com.tbse.mininews.ui.utils.BookmarkButton
import com.tbse.mininews.ui.utils.FavoriteButton
import com.tbse.mininews.ui.utils.ShareButton
import com.tbse.mininews.ui.utils.TextSettingsButton
import com.tbse.mininews.common.utils.isScrolled
import com.google.accompanist.insets.imePadding
import com.google.accompanist.swiperefresh.SwipeRefresh
import com.google.accompanist.swiperefresh.rememberSwipeRefreshState
import com.tbse.mininews.R
import com.tbse.mininews.domain.data.posts.mockImpl.BlockingFakePostsRepository
...
private fun HomeScreenWithList(
    ...
    Scaffold(
        scaffoldState = scaffoldState,
        snackbarHost = { MiniNewsSnackbarHost(hostState = it) },
        topBar = {
            if (showTopAppBar) {
                HomeTopAppBar(
                    openDrawer = openDrawer,
...
private fun PostList(
    postsFeed: com.tbse.mininews.domain.model.PostsFeed,
 ...
 */
@Composable
private fun PostListTopSection(post: com.tbse.mininews.domain.model.Post, navigateToArticle: (String) -> Unit) {
    Text(
...
private fun PostListSimpleSection(
    posts: List<com.tbse.mininews.domain.model.Post>,
...
private fun HomeTopAppBar(
    ...
    TopAppBar(
        title = {
            Icon(
                painter = painterResource(R.drawable.ic_mininews_wordmark),
...
fun PreviewHomeListDrawerScreen() {
    val postsFeed = runBlocking {
        (BlockingFakePostsRepository().getPostsFeed() as ServiceResult.Success).data
    }
    MiniNewsTheme {
        HomeFeedScreen(
            uiState = HomeUiState.HasPosts(

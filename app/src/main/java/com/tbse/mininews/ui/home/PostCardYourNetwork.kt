...
import com.tbse.mininews.domain.data.posts.mockImpl.*
import com.tbse.mininews.domain.model.Post
import com.tbse.mininews.domain.model.PostAuthor
...
fun PreviewPostCardPopular(
    @PreviewParameter(
        PostPreviewParameterProvider::class,
        limit = 1
    ) post: com.tbse.mininews.domain.model.Post
) {
    MiniNewsTheme {
 ...
 */
class PostPreviewParameterProvider : PreviewParameterProvider<com.tbse.mininews.domain.model.Post> {

...
sealed interface HomeUiState {
    ...
    val errorMessages: List<com.tbse.mininews.common.utils.ErrorMessage>
    ...
    fun refreshPosts() {
        ...
        viewModelScope.launch {
            ...
            viewModelState.update {
                when (result) {
                    is ServiceResult.Success -> it.copy(postsFeed = result.data, isLoading = false)
                    is ServiceResult.Error -> {
                        val errorMessages =
                            it.errorMessages + com.tbse.mininews.common.utils.ErrorMessage(

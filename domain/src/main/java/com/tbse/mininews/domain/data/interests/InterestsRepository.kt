...
package com.tbse.mininews.domain.data.interests
...
interface InterestsRepository {
     ...
     */
    suspend fun getTopics(): ServiceResult<List<InterestSection>>

    /**
     * Get list of people.
     */
    suspend fun getPeople(): ServiceResult<List<String>>

    /**
     * Get list of publications.
     */
    suspend fun getPublications(): ServiceResult<List<String>>
